...
namespace Ryujinx.HLE.HOS.Services.Sockets.Bsd
{
    class BsdContext : IDisposable
    {
        ...
        public void Dispose()
        {
            ...
            // [Nextendo] The keeper holds udp sockets past their close so Pia can reclaim the
            // same NAT mapping. The game is gone now, so nobody will: release them rather than
            // sit on the ports until they time out.
            Proxy.NextendoUdpPortKeeper.Clear();
        }
