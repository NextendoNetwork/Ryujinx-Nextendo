...
namespace Ryujinx.Ava
{
    public class RyujinxApp : Application
    {
        ...
        public static readonly string FullAppName = string.Intern(ReleaseInformation.IsCanaryBuild ? "Ryujinx Nextendo Canary" : "Ryujinx Nextendo");
        ...
        public override void OnFrameworkInitializationCompleted()
        {
            ...
            {
                // [Nextendo] New Harbor-based UI, opt-in via NEXTENDO_UI=harbor.
                // Legacy MainWindow stays the default until the new shell reaches parity.
                bool useHarborShell = string.Equals(
                    System.Environment.GetEnvironmentVariable("NEXTENDO_UI"),
                    "harbor",
                    System.StringComparison.OrdinalIgnoreCase);

                desktop.MainWindow = useHarborShell
                    ? new Shell.ShellWindow()
                    : new MainWindow();
            }
